...
Node.js (v18 or later)	Runs JavaScript outside the browser	nodejs.org
Git	Version control	git-scm.com
VS Code (recommended)	Code editor	code.visualstudio.com
MongoDB Atlas account (free)	Cloud database	mongodb.com/atlas
...
Dashboard — view an overview of your pharmacy's stats
Inventory — click "Add Medicine" to start adding stock
Sales — search and click medicines to add them to the cart, then complete a sale
Alerts — monitor low-stock and expiring medicines
Reports — view sales trends and category breakdowns
Settings — view your account info and toggle light/dark theme
---
